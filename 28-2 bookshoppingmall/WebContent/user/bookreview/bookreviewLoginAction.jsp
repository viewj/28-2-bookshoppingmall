	...
	<body>
		<%	
			...
			if(resultOfLogin.equals("로그인성공")){
				...
				response.sendRedirect(request.getContextPath() + "/user/bookreview/bookreviewLoginForm.jsp");
			} else{
			...
			System.out.println("");
			System.out.println("End of user/bookreview/bookreviewLoginAction.jsp");
