		...
		<div>
			<form action="../book/updateBookAction.jsp" method="post">
				<div>
					...
					%>
							<select name="bookCodeName">
								<option><%=bookCode.getBookcodeName()%></option>
							</select>
							<input type="hidden" name="bookCodeNo" value="<%=bookCode.getBookcodeNo()%>">
					<%
						}
					%>
				</div>
